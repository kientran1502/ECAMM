...
<body>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.status === 'success') {
                        ...
                        showModalAlert('danger', 'fail!', 'alert-noitification');
                    }
                }
            });
        });
        ...
        $('#edit-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.status === 'success') {
                        showModalAlert(res.status, res.message, 'alert-admin');
        ...
        function showModalAlert(type, message, id_modal) {
            const alertHtml = `
            ...
            $('#' + id_modal).html(alertHtml).slideDown();

            setTimeout(function() {
                $('#' + id_modal + ' .alert').alert('close');
                location.reload();
            }, 1000);
        }
        ...
        $('#committeesForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.status === 'success') {
                        showModalAlert(res.status, res.message, 'alert-committee');
                    }
                }
            })
        });
        ...
        $('#editCommitteesForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    showModalAlert(res.status, res.message, 'editCommitteeModal');
        ...
        $(document).on('click', '.accept-admin', function() {
            const id = $(this).data('id');
            $.ajax({
                url: '../controls/save_admin.php',
                type: 'POST',
                data: {
                    id: id
                },
        ...
        $(document).on('click', '.delete-request-admin', function() {
            const id = $(this).data('id');
            if (confirm("Are you sure to delete this request?")) {
                $.ajax({
                    url: '../controls/delete_admin_request.php',
                    type: 'POST',
                    data: {
                        id: id
                    },
